...
* __Nothing.__ If the residuals are $\sim$normally distributed and the spread isn't bad, this isn't a terrible assumption (remember, no model is ever going to be 100% correct, so this can be a viable option in some cases).
