...
<center>
<a href="https://www.codecogs.com/eqnedit.php?latex=\dpi{300}&space;\tiny&space;y_i&space;=&space;\beta_0&space;&plus;&space;\beta_1&space;\times&space;x_{i}&space;&plus;&space;\varepsilon_i&space;\quad\quad&space;\varepsilon_i&space;\sim&space;\mathcal{N}(0,\,&space;V)&space;\quad\quad&space;V&space;=&space;\sigma^2&space;{\begin{bmatrix}1&&space;0&space;&\cdots&space;&&space;0&space;\\&space;0&space;&&space;1&space;&&space;\cdots&space;&&space;0&space;\\&space;\vdots&space;&\vdots&space;&\ddots&space;&\vdots&space;\\&space;0&space;&&space;0&space;&&space;\cdots&space;&1&space;\end{bmatrix}}" target="_blank"><img src="https://latex.codecogs.com/png.latex?\dpi{300}&space;\tiny&space;y_i&space;=&space;\beta_0&space;&plus;&space;\beta_1&space;\times&space;x_{i}&space;&plus;&space;\varepsilon_i&space;\quad\quad&space;\varepsilon_i&space;\sim&space;\mathcal{N}(0,\,&space;V)&space;\quad\quad&space;V&space;=&space;\sigma^2&space;{\begin{bmatrix}1&&space;0&space;&\cdots&space;&&space;0&space;\\&space;0&space;&&space;1&space;&&space;\cdots&space;&&space;0&space;\\&space;\vdots&space;&\vdots&space;&\ddots&space;&\vdots&space;\\&space;0&space;&&space;0&space;&&space;\cdots&space;&1&space;\end{bmatrix}}" title="\tiny y_i = \beta_0 + \beta_1 \times x_{i} + \varepsilon_i \quad\quad \varepsilon_i \sim \mathcal{N}(0,\, V) \quad\quad V = \sigma^2 {\begin{bmatrix}1& 0 &\cdots & 0 \\ 0 & 1 & \cdots & 0 \\ \vdots &\vdots &\ddots &\vdots \\ 0 & 0 & \cdots &1 \end{bmatrix}}" /></a>
</center>
</br>
...
<!-- </br> -->
<!-- <center> -->
<!-- $V = \underbrace{{\begin{bmatrix}\theta + \sigma^2& \theta &\cdots & \theta \\ \theta & \theta + \sigma^2 & \cdots & \theta \\ \vdots &\vdots &\ddots &\vdots \\ \theta & \theta & \cdots &\theta + \sigma^2 \end{bmatrix}}}_{\mathrm{variance-covariance \, matrix}}$ -->
<!-- </center> -->
<!-- </br> -->
...
<!-- </br> -->
<!-- <center> -->
<!-- $V = \sigma^2 \underbrace{{\begin{bmatrix}1& \rho & \rho^2 &\cdots & \rho^i \\ \rho & 1 & \rho & \ddots & \vdots \\ \rho^2 & \rho & 1 & \ddots & \rho^2 \\ \vdots &\ddots &\ddots &\ddots & \rho \\ \rho^1 & \cdots & \rho^2 & \rho &1 \end{bmatrix}}}_{\mathrm{correlation \, matrix}}$ -->
<!-- </center> -->
<!-- </br> -->
