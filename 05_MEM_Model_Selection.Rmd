...
__Note:__ Make sure that all of the models are fit using ML. Models fit by a mix of ML and REML can not be compared using likelihood ratio tests, and models fit using REML can not usually be compared by AIC (there are certain cases where this is possible, but they are few).
</ol>
...
1. <ol>
* Provide a brief biological description the selected model (you can read how [Roulin and Bersier (2007)](https://doi.org/10.1016/j.anbehav.2007.01.027) described their results from these same data).
