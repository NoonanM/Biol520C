...
```{r, echo = FALSE}
setwd("~/Dropbox (Personal)/Teaching_Material/Biol_520C/Practicals/03_MLR_and_Residuals")
```
...
* Use a for loop to sequentially add 30 predictor variables, made up of Gaussian noise (i.e., noise variables simulated from a Gaussian distribution), to a model predicting y (i.e., model$_1: y_i = \beta_0 + \beta_1x_1$; model$_2: y_i = \beta_0 + \beta_1x_1 + \beta_2x_2$, etc...). 
...
1. <ol>
* Generate a dataset of 40 normally distributed y values
* Again, use a for loop to sequentially add 30 predictor variables, made up of Gaussian noise (i.e., noise variables simulated from a Gaussian distribution), to a model predicting y (i.e., model$_1: y_i = \beta_0 + \beta_1x_1$; model$_2: y_i = \beta_0 + \beta_1x_1 + \beta_2x_2$, etc...).
...
1. <ol>
* Using the seedling dataset, generate 30 data points with values of 0 for Dm_seedling_density, but uniformly distributed across the range of all other predictors variables
